...
uniform float alpha;
uniform sampler2D tex_BG, tex_SM, tex_SI, tex_Env;
uniform sampler2D tex_DI0, tex_DI1, tex_DI2, tex_DI3, tex_DI4, tex_DI5, tex_DI6, tex_DI7, tex_DI8, tex_DI9;
uniform int num_tex_DI;
uniform float dist;
...
void main()
{
    ...
    vec4 Shadow_blend = mix( texture2D(tex_DI0, gl_TexCoord[0].st),  texture2D(tex_DI1, gl_TexCoord[0].st), center_cos);
